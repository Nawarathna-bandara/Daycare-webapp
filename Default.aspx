<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeFile="Default.aspx.cs" Inherits="Bookings" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent"> 
       ...
       <asp:UpdatePanel runat="server" id="UpdatePanel5" updatemode="Conditional">
        ...
        <table style="background:#eeecec; border:1px #828282 solid;" width="100%" id="name_select" runat="server"> 
    ...
    <br/>
     ...
     <ul class="nav nav-tabs" id="tabs" runat="server">
        <li role="presentation" class="active"><a href="Default.aspx"><asp:Literal runat="server" id="Nextweektab" EnableViewState="false" /></a></li>
        <li role="presentation" style="background-color:#f0dff8"><a href="ThisWeek.aspx"><asp:Literal runat="server" id="Thisweektab" EnableViewState="false" /></a></li>
     </ul>


    <div class="panel panel-primary" aria-disabled="true" id="booking_table" runat="server">
            ...
            <td>
                 ...
                 <div class="panel panel-primary" id ="tue_panel" runat="server">
                  ...
                  <div class="panel-body"> 
                      ...
                      <%--<asp:CheckBox ID="chkTue" runat="server"  Text="Mon" AutoPostBack="true" OnCheckedChanged="chkTue_CheckedChanged" Enabled="false" />--%>
            ...
            <td>
                 ...
                 <div class="panel panel-primary" id ="wed_panel" runat="server">
                  ...
                  <div class="panel-body"> 
                     ...
                     <%-- <asp:CheckBox ID="chkWed" runat="server"  Text="Mon" AutoPostBack="true" OnCheckedChanged="chkWed_CheckedChanged" Enabled="false" />--%>
                 ...
                 <div class="panel panel-primary" runat="server" id="thu_panel">
                  ...
                  <div class="panel-body"> 
                    ...
                    <asp:UpdatePanel runat="server" id="UpdatePanel9" updatemode="Conditional">
                     ...
                     <%--<asp:CheckBox ID="chkThu" runat="server"  Text="Mon" AutoPostBack="true" OnCheckedChanged="chkThu_CheckedChanged" Enabled="false" />--%>
            ...
            <td>
                 ...
                 <div class="panel panel-primary" id ="fri_panel" runat="server">
                  ...
                  <div class="panel-body"> 
                      ...
                      <%--<asp:CheckBox ID="chkFri" runat="server"  Text="Mon" AutoPostBack="true" OnCheckedChanged="chkFri_CheckedChanged" Enabled="false" />--%>
    ...
    <asp:UpdatePanel runat="server" id="tableupdate" updatemode="Conditional">
        ...
        <div class="panel panel-primary" id="morning" runat="server">
        ...
        <tr>
            <td colspan="11" style="text-align:center">
                <span style="color:black"> Safe </span>, <span style="color:darkorange"> Tentative </span>, <span style="color:darkred"> Disqualified </span> 
            </td></tr>
    ...
    <div class="panel panel-primary" id="evening" runat="server">
    ...
    <script>
        ...
        function highlight(id,search,replace){
            var string = document.getElementById(id).innerHTML;
            var reg = new RegExp(search,"g");
            document.getElementById(id).innerHTML = string.replace(reg,replace);
        }
